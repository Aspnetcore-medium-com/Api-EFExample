...
namespace ServiceContracts
{
    public interface IPersonService
    {
        ...
        Task<PersonResponse> AddPerson(PersonAddRequest personAddRequest,CancellationToken cancellationToken = default);
        ...
        /// <returns></returns>
        Task<PersonResponse?> GetPersonById(Guid personId,CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        Task<IReadOnlyList<PersonResponse>> GetAllPersons(CancellationToken cancellationToken = default);
        ...
        /// <returns></returns>
        Task<IReadOnlyList<PersonResponse>> GetPersonsBy(string searchString, string columnName,CancellationToken cancellationToken = default);
        ...
        /// <returns></returns>
        Task<IReadOnlyList<PersonResponse>?> GetPersonsWithSorting(string columnName, SortOptions sortOptions, CancellationToken cancellationToken = default);
        ...
        /// <returns></returns>
        Task<PersonResponse> UpdatePerson(PersonUpdateRequest personUpdateRequest,CancellationToken cancellationToken = default);
        /// <summary>
